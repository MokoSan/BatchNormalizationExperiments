...
def Inception_Module(name, pooled_input, filters, activation):
...
def GoogleNet(input_shape=(224, 224, 3), activation='relu'):
    ...
    conv2_3x3_reduce = Convolution2D(64, (1, 1), padding='same', activation=activation, name='conv2/3x3_reduce')(pool1_norm1)

    conv2_3x3 = Convolution2D(192, (3, 3), padding='same', activation=activation, name='conv2/3x3')(conv2_3x3_reduce)
    ...
    inception_3a_output = Inception_Module(name='3a',
    ...
    inception_3b_output = Inception_Module(name='3b',
                                           pooled_input=inception_3a_output,
                                           filters=filters_3b,
                                           activation=activation)
    ...
    inception_4a_output = Inception_Module(name='4a',
    ...
    loss1_conv = Convolution2D(128, (1, 1), padding='same', activation=activation, name='loss1/conv')(loss1_ave_pool)
    ...
    inception_4b_output = Inception_Module(name='4b',
    ...
    inception_4c_output = Inception_Module(name='4c',
    ...
    inception_4d_output = Inception_Module(name='4d',
    ...
    inception_4e_output = Inception_Module(name='4e',
    ...
    inception_5a_output = Inception_Module(name='5a',
    ...
    inception_5b_output = Inception_Module(name='5b',
